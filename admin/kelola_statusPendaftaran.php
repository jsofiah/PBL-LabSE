...
$qTotal = "SELECT COUNT(*) FROM status_pendaftaran";
...
$qStatus = "SELECT * FROM status_pendaftaran 
            ORDER BY id_statuspendaftaran ASC 
...
<div class="content-area container-fluid px-3">
    ...
    <div class="mb-4">
        <h2 class="mb-2">Kelola Status Pendaftaran</h2>
        <a href="tambah_status.php" class="btn btn-success">
    ...
    <div class="table-container">
        <div class="table-responsive">
            <table class="table modern-table">
                ...
                <tbody>
                <?php if (pg_num_rows($rStatus) > 0) : ?>
                    <?php $no = $offset + 1; ?>
                    <?php while ($st = pg_fetch_assoc($rStatus)) : ?>
                        <tr>
                            <td class="text-center"><?= $no++; ?></td>
                            <td class="text-center"><?= htmlspecialchars($st['nama_statuspendaftaran']); ?></td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="empty-state">
                                ...
                                <p class="text-muted">
                                    Tidak ada data status pendaftaran yang ditemukan.
                                </p>
                            </div>
                        </td>
                    </tr>
