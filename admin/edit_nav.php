            ...
            <form method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama_nav" class="form-control" placeholder="Masukkan nama nav" value="<?= htmlspecialchars($nav['nama_nav']); ?>" required>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label text-white">URL Nav</label>
                        <input type="text" name="url_nav" class="form-control" placeholder="Masukkan url nav" value="<?= htmlspecialchars($nav['url_nav']); ?>" required>
                    </div>
                </div>
