    ...
    <div class='card shadow-sm p-4'>
        <form method='POST'>
            ...
            <div class='mb-3'>
                ...
                <input type='text' name='judul' placeholder="Masukkan judul publikasi" class='form-control' value='<?= htmlspecialchars($pub['judul_publikasi']); ?>' required>
            </div>

            <div class='mb-3'>
                <label class='form-label text-white'>Tahun</label>
                <input type='number' name='tahun' class='form-control' placeholder="Masukkan tahun penelitian" value='<?= htmlspecialchars($pub['tahun_publikasi']); ?>' min="1990" max="2100" required>
            </div>
