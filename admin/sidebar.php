        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-item">
                ...
                <div class="submenu" id="profil">
                    <a href="kelola_kontenlab.php" class="submenu-link"><i class="fas fa-info-circle"></i> Konten Lab</a>
                    <a href="kelola_peranLab.php" class="submenu-link"><i class="fas fa-lightbulb"></i> Peran Lab</a>
