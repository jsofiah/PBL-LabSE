<?php
    ...
    if (!empty($search)) {
        $where_conditions[] = "nama_keahlian ILIKE $" . $param_count;
        $params[] = "%$search%";
        $param_count++;
    }
    ...
    $qTotal = "SELECT COUNT(*) FROM vw_bidang_keahlian $where_clause"; 
    ...
    if ($total_records > 0) {
        $qViewKeahlian = "
            SELECT * FROM vw_bidang_keahlian 
            $where_clause
            ORDER BY id_keahlian ASC
...
<head>
    ...
    <title>Kelola Bidang Keahlian</title>
...
<body>
    ...
    <div class="content-area container-fluid px-3">
        <div class="mb-4">
            <h2 class="mb-2">Kelola Bidang Keahlian</h2>
            <a href="tambah_keahlian.php" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Keahlian</a>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons text-center">
                                        <a href="edit_keahlian.php?id=<?= $keahlian['id_keahlian']; ?>" 
                                           class="btn btn-action btn-warning btn-sm">
                                            <i class="fa fa-edit"></i> Edit
                                        </a>

                                        <a href="hapus_keahlian.php?id=<?= $keahlian['id_keahlian']; ?>" 
                                ...
                                <td colspan="3">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-muted">
                                            ...
                                            <?php else: ?>
                                                Tidak ada data bidang keahlian yang ditemukan.
                                            <?php endif; ?>
                                        </p>
                                    </div>
                                </td>
