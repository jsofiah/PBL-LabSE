<?php
    ...
    $qTotal = "SELECT COUNT(*) FROM vw_bidang_keahlian"; 
...
<body>
    ...
    <div class="content-area container-fluid px-3">
        <div class="mb-4">
            ...
            <a href="tambah_keahlian.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Keahlian</a>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-fixed">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td colspan="3" class="text-center">Tidak ada data Bidang Keahlian yang ditemukan.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
