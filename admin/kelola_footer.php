...
<body>
    ...
    <div class="content-area container">
        ...
        <div class="mb-4 mt-4">
            ...
            <a href="tambah_sosmed.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Sosial Media</a>
        </div>
                ...
                <tbody>
                    ...
                    <?php while($sosmed = pg_fetch_assoc($rViewSosmed)) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="edit_sosmed.php?id=<?= $sosmed['id_social']; ?>" class="btn btn-warning btn-sm">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <a href="hapus_sosmed.php?id=<?= $sosmed['id_social']; ?>" class="btn btn-danger btn-sm"
