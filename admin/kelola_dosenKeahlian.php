<?php
    ...
    if (!empty($search)) {
        $where_conditions[] = "(nama_dosen ILIKE $" . $param_count . " OR nama_keahlian ILIKE $" . $param_count . ")";
        $params[] = "%$search%";
        $param_count++;
    }
    ...
    $qTotal = "SELECT COUNT(*) FROM vw_dosen_keahlian $where_clause"; 
...
<head>
    ...
    <title>Kelola Keahlian Dosen</title>
...
<body>
    ...
    <div class="content-area container-fluid px-3">
        <div class="mb-4">
            ...
            <a href="tambah_keahlianDosen.php" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Keahlian Dosen</a>
        </div>
                                ...
                                <td colspan="4">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-muted">
                                            ...
                                            <?php else: ?>
                                                Tidak ada data keahlian dosen yang ditemukan.
                                            <?php endif; ?>
                                        </p>
                                    </div>
                                </td>
