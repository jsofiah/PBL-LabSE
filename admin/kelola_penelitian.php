<?php
    ...
    $qViewPenelitian = "
        SELECT * FROM vw_penelitian_dosen
        $where_clause
...
<body>
    ...
    <div class="mb-4">
        ...
        <a href="tambah_penelitian.php" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Penelitian</a>
    </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-5">
                ...
                <div class="search-box">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Cari judul penelitian atau nama dosen..."
            ...
            <div class="col-md-2">
                ...
                <select name="tahun" class="form-select filter-select">
                    ...
                    <?php while($t = pg_fetch_assoc($rTahun)): ?>
                        <option value="<?= $t['tahun_penelitian'] ?>" <?= $filter_tahun == $t['tahun_penelitian'] ? 'selected' : '' ?>>
                            <?= $t['tahun_penelitian'] ?>
                        </option>
                    <?php endwhile; ?>
                </select>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center text-nowrap">
                <a href="edit_penelitian.php?id=<?= $p['id_penelitian']; ?>" class="btn btn-warning btn-sm">
                    <i class="fa fa-edit"></i> Edit
                </a>
                <a href="hapus_penelitian.php?id=<?= $p['id_penelitian']; ?>" class="btn btn-danger btn-sm"
