        ...
        <div class="card shadow-sm p-4 form-card">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" placeholder="Masukkan judul CTA" class="form-control"
                        value="<?= htmlspecialchars($data['judul_cta']); ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label text-white">Link CTA</label>
                    <input type="text" name="link" placeholder="Masukkan link CTA" class="form-control"
