<?php
    ...
    $jenis = intval($jenis);
    return pg_query($conn, "SELECT * FROM vw_fasilitas_lengkap WHERE id_jenisFasilitas=$jenis ORDER BY id_fasilitas");
}
...
<head>
    ...
    <title>Laboratorium Software Engineer - Fasilitas</title>
